...
export default function TutorDataToServerTwoEdit(props) {
    ...
    const handleSubmit = async () => {
        ...
        if(validadorFormIni.flag === true){
            ...
            let res = {};
            await fetch(`${server}tutors/${props._id}`,
            {
                method: "PUT",
    ...
    <>  
        ...
        >
            ...
            <div style={{textAlign: "center"}} className="column is-full">
                ...
                <h4 className="subtitle is-4">¡Su perfil como monitor a sido editado satisfactoriamente!</h4>
        ...
        <DialogContent>  
            ...
            <div style={{textAlign: "center"}} className="column is-full">
                ...
                <h4 className="subtitle is-4">La información no se pudo actualizar.</h4>
        ...
        <DialogContent>  
            ...
            <div style={{textAlign: "center"}} className="column is-full">
                <h3 className="title is-3">¿Estás seguro de cancelar la edición del perfil?</h3>
